...
data = np.load（' C：/ Users / 3SXL_21145 / Desktop / populations .npz '，allow_pickle = True）＃读入数据
打印（data [ ' data ' ]）＃输出数据数组
名称=数据[ ' feature_names ' ] ＃提取其中的feature_names分散，视为数据的标签
values = data [ ' data ' ] ＃提取数据副本，视为数据的存在位置
...
plt.savefig('C:/Users/3SXL_21144/Desktop/tmp/1996、2015年各类人口直方图.png')
...
plt.savefig('C:/Users/3SXL_21144/Desktop/tmp/1996、2015年各类人口饼图.png')
...
plt.savefig('C:/Users/3SXL_21144/Desktop/tmp/1996`2015年各特征人口箱线图.png')
