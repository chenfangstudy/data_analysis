...
data = np.load('D\zuoye\chapter_3\populations.npz', allow_pickle=True)
...
plt.savefig('../tmp/1996~2015年人口特征分析直线图')
#饼图
p2 = plt.figure(figsize=(20, 20))
...
plt.savefig('../tmp/1996~2015年人口特征分析饼图')
...
plt.xlabel('类型')
plt.ylabel('人口(万)')
plt.savefig('../tmp/1996~2015年人口特征分析箱线图')
