# -*- coding: utf-8 -*-
"""
Created on Wed Sep 18 21:12:01 2019
...
data=np.load('C:/ZX/populations.npz',allow_pickle=True)#读入数据
...
plt.savefig('C:/ZX/1996、2015年各类人口直方图.png')#保存图片
...
plt.savefig('C:/ZX/1996、2015年各类人口饼图.png')
...
plt.savefig('C:/ZX/1996`2015年各特征人口箱线图.png')
