...
plt.ylabel('人口（万人）')
plt.ylim(0,80000)#设置y轴的范围
plt.xticks(range(2),label1)#设置x轴刻度的数目与取值
...
plt.savefig('C:/Users/3SXL_21145/Desktop/tmp/1996、2015年各类人口直方图.png')
...
plt.savefig('C:/Users/3SXL_21145/Desktop/tmp/1996、2015年各类人口饼图.png')
...
plt.savefig('C:/Users/3SXL_21145/Desktop/tmp/1996`2015年各特征人口箱线图.png')
