...
import pandas as pd
import numpy as np
pdd = pd.read_csv('第4章\Training_Master.csv',sep=',',encoding="gbk")
print(pdd.ndim)#维度
print(pdd.shape)#大小
print(pdd.memory_usage())#内存信息
print(pdd.describe())
...
pon = pd.read_csv('第4章\Training_LogInfo.csv',sep=',',encoding='gbk')
pup = pd.read_csv('第4章\Training_Userupdate.csv',sep=',',encoding='gbk')
