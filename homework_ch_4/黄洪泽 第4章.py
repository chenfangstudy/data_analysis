...
ppd = pd.read_csv('../111\Training_Master.csv',sep=',',encoding="gbk")
   print(ppd.ndim)#维度
   print(ppd.shape)#大小
...
pon = pd.read_csv('../111\Training_LogInfo.csv',sep=',',encoding='gbk')
pup = pd.read_csv('../111\Training_Userupdate.csv',sep=',',encoding='gbk')
