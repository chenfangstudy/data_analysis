...
ppd = pd.read_csv('data\ch4\实训数据\Training_Master.csv',sep=',',encoding="gbk")
print(ppd.ndim)#主表的维度
print(ppd.shape)#主表的形状大小
print(ppd.memory_usage())#主表的内存信息
print(ppd.describe())#描述性统计
...
dropNullStd(ppd)#使用dropNullStd函数对信息表进行操作

#第4章实训2

pon = pd.read_csv('data\ch4\实训数据\Training_LogInfo.csv',sep=',',encoding='gbk')
pup = pd.read_csv('data\ch4\实训数据\Training_Userupdate.csv',sep=',',encoding='gbk')
