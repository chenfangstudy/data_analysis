...
main = pd.read_csv('data\第4章\Training_Master.csv',sep=',',encoding="gbk")
print("主表的维度为：",main.ndim)
print("主表的形状为：",main.shape)
print("主表的形状为：",main.memory_usage())
print("主表的索引为：",main.index)
print("主表的值为：",main.values)
print("主表的列名为：",main.columns)
print("主表的数据类型为：",main.dtypes)
print("主表的元素个数为：",main.size)
print("主表的描述统计为：",main.describe())
