...
db = pymysql.connect("localhost", "root", "531820", "testdb")
cursor = db.cursor()
cursor.execute("SELECT * FROM meal_order_detail1")
...
engine = create_engine('mysql+pymysql://root:531820@localhost:\3306/testdb)
